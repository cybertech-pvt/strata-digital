  ...
  return (
    <Layout>
      ...
      <section className="pt-32 pb-20 relative overflow-hidden bg-navy">
        ...
        <div className="absolute inset-0 bg-gradient-to-tl from-teal/5 via-transparent to-lime/5" />
        ...
        <div className="absolute top-1/2 left-0 w-[350px] h-[350px] bg-gradient-radial from-lime/10 to-transparent rounded-full" />
