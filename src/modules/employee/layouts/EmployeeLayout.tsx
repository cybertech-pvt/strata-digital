...
/**
 * EmployeeLayout - Layout for employee portal
 * 
 * Provides navigation specific to company employees.
 */
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-navy border-r border-teal/20">
        ...
        <div className="p-6 border-b border-teal/20">
          <Link to="/employee/dashboard" className="flex items-center gap-3">
            <img src={logoDark} alt="Employee Portal" className="h-10" />
            <span className="text-white/60 text-sm">Employee Portal</span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-teal/20">
          <div className="flex items-center gap-3 mb-4 px-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/50 text-xs">Employee</p>
            </div>
          </div>
          <Button
        ...
        <div className="lg:hidden bg-navy border-b border-teal/20 p-4">
          <div className="flex items-center justify-between">
            <Link to="/employee/dashboard" className="flex items-center gap-2">
              <img src={logoDark} alt="Employee Portal" className="h-8" />
            </Link>
            <Button
              onClick={handleSignOut}
              variant="ghost"
